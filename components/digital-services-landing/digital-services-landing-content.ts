...
import { caseStudiesForPoleLanding, getDigitalCaseStudies } from "@/lib/case-studies-catalog";
...
export type { CaseStudyItem } from "@/lib/case-study-item";
...
export const SECTOR_CARDS: SectorCard[] = [
  ...
  },
  {
    ...
    imageAlt: "Communication digitale et parcours patients dans la santé",
    imageSizes: "(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw",
    badge: "Santé",
  },
  {
    ...
    imageAlt: "Services publics et communication institutionnelle",
    imageSizes: "(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw",
  ...
  },
  {
    ...
    imageAlt: "Transition énergétique et communication des acteurs utilities",
    imageSizes: "(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw",
    badge: "Énergie & utilities",
  },
];

const digitalCaseStudiesAll = getDigitalCaseStudies();
export const CASE_STUDIES: CaseStudyItem[] = digitalCaseStudiesAll;
/** Section cas clients sur la landing `/digital` (les plus récents du catalogue, max 6). */
export const CASE_STUDIES_LANDING: CaseStudyItem[] = caseStudiesForPoleLanding(digitalCaseStudiesAll);
