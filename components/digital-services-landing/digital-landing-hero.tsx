...
import { DigitalHeroIllustration } from "./digital-hero-illustration";
    ...
    <header className={`relative overflow-x-clip ${BRAND.canvas.bgClass}`}>
      <div className={PAGE_X}>
        <div className="mx-auto w-full max-w-screen-xl pt-4 pb-8 sm:pt-6 sm:pb-10 lg:pt-8 lg:pb-12">
          <div
            className={`bg-emerald-100 ${R_CARD} ${BD_CARD} ${RING_SOFT} ${SHADOW_SURFACE}`}
          >
            <div
            ...
            <div className="relative order-1 mx-auto w-full max-w-md py-6 lg:order-2 lg:mx-0 lg:max-w-none lg:py-8">
              <DigitalHeroIllustration />
            </div>
            </div>

            <div
              className={`group overflow-hidden rounded-b-2xl border-t border-black/[0.08] ${BG_INK} py-4 sm:py-5`}
              role="region"
