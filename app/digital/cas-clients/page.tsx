...
const casClientsPath = "/digital/cas-clients";
const casClientsCanonical = absoluteUrl(casClientsPath);
const previewStudy = CASE_STUDIES[0];

export const metadata: Metadata = {
  title: "Cas clients — Pôle Digital Ovedex",
  description:
    "Découvrez des exemples de projets web, e-commerce et marketing digital menés avec nos clients.",
  alternates: { canonical: casClientsCanonical },
  openGraph: {
    title: "Cas clients — Pôle Digital Ovedex",
    description:
      "Découvrez des exemples de projets web, e-commerce et marketing digital menés avec nos clients.",
    type: "website",
    url: casClientsCanonical,
    locale: "fr_FR",
    ...(previewStudy
      ? {
          images: [
...
export default function DigitalCasClientsPage() {
  return (
